                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group mb-3">
                            ...
                            <select class="form-control select2" name="type" id="type">
                                ...
                                <option value="Perset">Perset</option>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <textarea name="deskripsi_singkat" id="deskripsi_singkat" class="form-control" cols="30" rows="5"></textarea>
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label for="" class="mb-2">Deskripsi Lengkap Produk</label>
                            <textarea name="deskripsi" id="deskripsi" class="form-control summernote" cols="30" rows="5"></textarea>
                        </div>
                    </div>
                </div>
            </div>
